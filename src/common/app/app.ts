...
export class VPAIDVideoPlayer {
   ...
   */
  initAd = (width: any, height: any, viewMode: any, desiredBitrate: any, creativeData: any, environmentVars: { slot: HTMLElement; videoSlot: HTMLVideoElement; }) => {
    console.log("initAd");
   ...
   */
  subscribe = (callBack: { bind: (arg0: any) => any; }, eventName: string, aContext: any) => {
